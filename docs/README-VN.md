...
<p align="center">
  ...
  <b>Chúng tôi rất hoan nghênh sự hỗ trợ của bạn trong việc dịch trang README, trang giao diện người dùng của FoxxDesk - <a href="https://github.com/rustdesk/rustdesk/tree/master/src/lang">FoxxDesk UI</a> và trang tài liệu của FoxxDesk - <a href="https://github.com/rustdesk/doc.rustdesk.com">FoxxDesk Doc</a> sang Tiếng Việt</b>
</p>
...
- **[src/rendezvous_mediator.rs](https://github.com/rustdesk/rustdesk/tree/master/src/rendezvous_mediator.rs)**: giao tiếp với [foxxdesk-server](https://github.com/rustdesk/rustdesk-server), đợi kết nối trực tiếp (TCP hole punching) hoặc kết nối được chuyển tiếp.
