...
const APP_PREFIX: &str = "FoxxDesk";
const APPNAME_RUNTIME_ENV_KEY: &str = "FOXXDESK_APPNAME";
#[cfg(windows)]
...
mod win {
    ...
    pub const WIN_TOPMOST_INJECTED_PROCESS_EXE: &'static str = "RuntimeBroker_foxxdesk.exe";
    ...
    pub(super) fn copy_runtime_broker(dir: &Path) {
        ...
        let _allow_err = Command::new("taskkill")
            .args(&["/F", "/IM", "RuntimeBroker_foxxdesk.exe"])
